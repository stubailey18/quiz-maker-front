...
export default function Home() {
    return (
        <>
            ...
            <p className="mb-1">There is, as yet, no back-end but you can make it work locally using <a href="https://github.com/typicode/json-server">json-server</a>. Add a .env file to the project's root directory with the following variables:</p>
            <ul>
